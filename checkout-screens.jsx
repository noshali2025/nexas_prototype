          ...
          {stage === 2 && (
            <>
              ...
              <div className="form-section">
                ...
                <div style={{ marginTop: 14, padding: 14, border: "1px dashed var(--line-2)", borderRadius: "var(--radius-sm)", textAlign: "center", background: "var(--surface-2)" }}>
                  <div style={{ fontSize: 13, color: "var(--muted)" }}>📷 Document photo capture</div>
                  <div style={{ fontSize: 11, color: "var(--muted)", marginTop: 4 }}>A link to scan your ID via phone will be sent after submission</div>
                </div>
              </div>
              ...
              <div className="form-section">
                <label style={{ display: "flex", gap: 10, alignItems: "start", cursor: "pointer", fontSize: 13, color: "var(--ink-2)" }}>
                  ...
                  <span>I confirm the details above are accurate and I consent to NexaPoint performing identity and credit checks with regulated providers. I understand this search may be recorded on my credit file.</span>
                </label>
